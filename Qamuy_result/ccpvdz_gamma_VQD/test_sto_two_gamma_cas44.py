...
input.ansatz.randomness_variance= 0.001
...
# add penalties
input.cost_function.overlap_weight = 1000000.
input.cost_function.s2_number_weight=10000.
input.cost_function.sz_number_weight=10000.
input.cost_function.particle_number_weight=10000.
