...
# add penalties
#input.cost_function.SSVQE_weights = [1.0, 0.5]
input.cost_function.SSVQE_weights = [100,10,1]
input.cost_function.overlap_weights= [100000,100000]
input.cost_function.s2_number_weight=1000000.
input.cost_function.sz_number_weight=1000000.
input.cost_function.particle_number_weight=1000000.
# exact simulator (state vector)
input.quantum_device.type = "EXACT_SIMULATOR"

input.mapping.type="BRAVYI_KITAEV"
